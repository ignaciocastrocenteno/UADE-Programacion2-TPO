...
public class DiccionarioSimpleModDin implements DiccionarioSimpleModTDA {
    private DiccionarioSimpleTDA dValores;
    private DiccionarioSimpleTDA dMods;

    public void inicializarDiccionario() {
        dValores = new DiccionarioSimpleDin(); // C
        dValores.inicializarDiccionario(); // C
        dMods = new DiccionarioSimpleDin(); // C
        dMods.inicializarDiccionario(); // C
    }

    public void agregar(int clave, int valor) {
        ConjuntoTDA claves = dValores.claves(); // L
